...
(function ($, window, document) {
    ...
    SelectList.prototype = {
        ...
        init: function () {
            ...
            that.setSelectValues(element);//设置默认值
        },
        //设置值
        setSelectValues: function (element) {
            ...
            if (defaultValues) {
                ...
                $('.select-list').find('li').each(function () {
                    if ($(this).text() == defaultValues) {
                        //$(this).addClass('selected').siblings().removeClass('selected');
                        //$(selectBtn).val($(this).text());
                        //$(selectValues).val($(this).attr('data-value'));
                        $(this)
                ...
                //默认值
                defaultValues = selectedOptionText;
            }
        },
        //获取原生选择列表id值
    ...
    $.extend({
        //设置多选值
        'setSelectValues': function (element, defaultValues) {
